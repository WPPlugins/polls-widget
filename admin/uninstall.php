  ...
  <?php
	...
	private function remove_databese_and_deactivete(){
		...
		<div class="wrap">
		  ...
		  <p><strong><a href="<?php echo wp_nonce_url('plugins.php?action=deactivate&amp;plugin=polls/polls.php', 'deactivate-plugin_polls/polls.php'); ?>">Click Here</a> To Finish the Polls Uninstallation</strong></p>
